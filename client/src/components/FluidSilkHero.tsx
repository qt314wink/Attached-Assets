...
export function FluidSilkHero({ setPage }: { setPage: (p: string) => void }) {
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <button 
              ...
              className="group relative px-12 py-5 bg-[#1A1A1A] rounded-full text-white font-medium tracking-widest text-sm uppercase overflow-hidden shadow-[0_10px_20px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.15)] transition-shadow"
            >
            ...
            <button 
              ...
              className="text-[#A39B8E] font-medium tracking-widest text-sm uppercase hover:text-[#1A1A1A] transition-colors relative group"
            >
              Explore Loom
