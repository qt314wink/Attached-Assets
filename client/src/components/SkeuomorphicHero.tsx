...
export function SkeuomorphicHero({ setPage }: { setPage: (p: string) => void }) {
  ...
  return (
    <div 
      className="min-h-[85vh] bg-[#1a1a1a] overflow-hidden relative flex items-center justify-center font-sans text-[#f8f8f8] pt-24 pb-12"
        ...
        <div className="flex-1 space-y-8">
          ...
          >
            ...
            <button 
              ...
              className="group relative px-8 py-4 rounded-3xl bg-[#252525] overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_4px_0_#00000030,0_-2px_0_#ffffff10] hover:shadow-[0_8px_20px_rgba(167,139,250,0.2),0_4px_0_#00000030,0_-1px_0_#ffffff20]"
            >
            ...
            <button 
              ...
              className="group relative px-8 py-4 rounded-3xl bg-transparent border border-[#333] overflow-hidden transition-all duration-500 hover:border-[#a78bfa]/50"
            >
