...
export function TextileHero({ setPage }: { setPage: (p: string) => void }) {
  const [tension, setTension] = useState(0);

  return (
    <div className="h-screen min-h-[800px] bg-[#F5F0E8] overflow-hidden relative flex flex-col justify-center font-sans text-[#2C2C2C]">
      ...
      <div className="w-full max-w-7xl mx-auto px-8 relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button 
              ...
              className="group px-8 py-5 text-[#FF9F1C] font-medium tracking-wider border-b-2 border-transparent hover:border-[#FF9F1C] transition-all flex items-center gap-2"
            >
        ...
        <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-full max-w-4xl flex justify-center gap-8 opacity-80 pointer-events-none hidden md:flex">
           {[
