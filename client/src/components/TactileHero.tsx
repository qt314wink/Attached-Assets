...
export function TactileHero({ setPage }: { setPage: (p: string) => void }) {
  const [hovered, setHovered] = useState(false);

  return (
    <div className="min-h-[85vh] bg-[#FAF7F2] overflow-hidden relative flex flex-col justify-center font-sans text-[#2A2A2A] selection:bg-[#2C3E7E] selection:text-white pt-24 pb-12">
        ...
        <div className="w-full md:w-6/12 flex flex-col items-start">
          ...
          <div className="flex flex-wrap items-center gap-6 w-full">
            <button 
              ...
              className="group relative overflow-hidden px-10 py-4 bg-[#2C3E7E] rounded-none text-white font-medium tracking-wide hover:bg-[#1E2D5D] transition-colors duration-300 flex items-center gap-4"
            >
            ...
            <button 
              ...
              className="px-6 py-4 text-[#2A2A2A] font-medium text-sm uppercase tracking-widest border-b border-transparent hover:border-[#2A2A28] transition-colors flex items-center gap-3 group"
            >
