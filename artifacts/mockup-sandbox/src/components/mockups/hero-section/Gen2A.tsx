...
export function Gen2A() {
  const [absorption, setAbsorption] = useState(30);
  const [resolution, setResolution] = useState(5000);

  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#e0e0e0] font-mono overflow-hidden relative flex flex-col p-8 md:p-16">
      {/* Background Grid */}
      ...
      <div className="flex flex-col md:flex-row gap-12 z-10 flex-1">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <button className="self-start px-6 py-3 border border-emerald-500/30 hover:bg-emerald-500/10 text-emerald-400 tracking-widest uppercase text-xs transition-colors rounded">
