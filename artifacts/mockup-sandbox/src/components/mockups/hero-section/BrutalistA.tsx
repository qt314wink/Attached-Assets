...
export function BrutalistA() {
  ...
  return (
    <div className="min-h-screen bg-[#E5E5E5] text-black font-sans overflow-hidden relative">
      ...
      <div className="max-w-[1440px] mx-auto p-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 h-screen items-center">
          ...
          <div className="bg-white border-4 border-black p-6 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col gap-4 transform hover:-translate-y-1 transition-transform max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              ...
              <button 
                ...
                className="flex-1 bg-black text-white font-bold uppercase tracking-widest text-sm py-4 hover:bg-[#FF3366] border-4 border-black transition-colors"
              >
