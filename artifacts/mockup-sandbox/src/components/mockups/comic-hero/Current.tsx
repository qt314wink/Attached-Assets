      ...
      <div className="bg-white relative font-sans p-4 md:p-8 pt-24 pb-8 border-b-8 border-black">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 h-full auto-rows-fr">
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
              {/* Panel 2: CTA */}
              <div className="flex-1 border-[6px] border-black bg-[#FFFF00] p-8 flex flex-col justify-center items-center text-center group cursor-pointer hover:bg-[#00E5FF] transition-colors shadow-[12px_12px_0_#000]">
              ...
              <div className="flex-1 border-[6px] border-black bg-white p-8 flex flex-col justify-center relative overflow-hidden group shadow-[12px_12px_0_#000] cursor-pointer">
